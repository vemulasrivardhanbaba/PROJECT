...
<%
					...
					try {
						...
						if(utype.equalsIgnoreCase("end user"))
						{
					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="usermain.jsp">Click here to Login</a>         <a href="index.html">Home</a> </p>
					   ...
					   {
						PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,dob,gender,address,pincode,image) values(?,?,?,?,?,?,?,?,?)");
			...
			<%
					...
					if ( rs1.next() )
					   ...
					   {
						PreparedStatement ps=connection.prepareStatement("insert into owner(username,password,email,mobile,dob,gender,address,pincode,image) values(?,?,?,?,?,?,?,?,?)");
						ps.setString(1,uname);
						ps.setString(2,pass);
						ps.setString(3,email);	
						ps.setString(4,mno);
