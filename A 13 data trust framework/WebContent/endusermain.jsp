...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Welcome  to End User :: <%=application.getAttribute("user") %></h2>
          <p>&nbsp;</p>
          <div class="clr"></div>
          <p align="center"><img src="images/EndUser.png" width="357" height="226" /></p>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li><a href="#">Home</a></li>
            <li><a href="FileRequest.jsp">Request Data </a></li>
            <li><a href="ViewFileResponse.jsp">View Data Response </a></li>
            <li><a href="Download.jsp">Create Blockchain & Download Data </a></li>
