...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Welcome to Cloud Server Provider... </h2>
          <p>&nbsp;</p>
          <p align="center"><img src="images/CS.jpg" width="555" height="403" /></p>
          <div class="clr"></div>
        </div>
        <p class="pages">&nbsp;</p>
      </div>
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li><a href="#">Home</a></li>
            <li><a href="ViewAllDataOwners.jsp">View Data Owners </a></li>
            <li><a href="EndUsers.jsp">View End Users </a></li>
            <li class="active"><a href="ViewHashTable.jsp">View Uploaded Data</a></li>
			<li class="active"><a href="ViewFileRequest.jsp">View Data Request</a></li>
			<li class="active"><a href="ViewTransaction.jsp">View Transactions</a></li>
			<li class="active"><a href="ViewAttackers.jsp">View Attackers</a></li>
			<li class="active"><a href="ViewResults.jsp">View Results</a></li>
			<li class="active"><a href="ViewResults1.jsp">View Time Delay Results</a></li>
			<li class="active"><a href="ViewResults2.jsp">View Throughput Results</a></li>
           <li><a href="csprovider.jsp">Logout </a></li>
          </ul>
        </div>
      </div>
