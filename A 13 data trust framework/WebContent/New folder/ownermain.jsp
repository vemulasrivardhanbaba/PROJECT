    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p>&nbsp;</p>
          <div class="clr">
            <p align="center"><img src="images/Owner.jpg" width="650" height="316" /></p>
          </div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li><a href="#">Home</a></li>
            <li><span class="style2"><span class="style3"><span class="style5"><span class="style7"><a href="Upload.jsp">Upload Blocks </a></span></span></span></span></li>
            <li class="style8"><a href="VerifyBlock.jsp">Data Auditing By Blockchain </a></li>
			<li class="style8"><a href="UpdateBlock.jsp">Update Block </a></li>
	        <li class="style8"><a href="DeleteFile.jsp">Delete File </a></li>
            <li><span class="style8"><a href="OViewFiles.jsp">View Uploaded Blocks </a></span></li>
            <li><a href="usermain.jsp">Logout</a></li>
          </ul>
        </div>
      </div>
