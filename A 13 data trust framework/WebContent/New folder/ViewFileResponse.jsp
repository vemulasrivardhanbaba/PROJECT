...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>View File Response </h2>
          <p>&nbsp;</p>
          <div class="clr"></div>
          <p>&nbsp;</p>
          <table width="800" border="1" align="center">
  <tr>
   <td bgcolor="#FF0000" ><div align="center" class="style3"><strong>User Name</strong></div></td>
      <td bgcolor="#FF0000" ><div align="center" class="style3"><strong>FileName Requested</strong> </div></td>
    <td bgcolor="#FF0000" ><div align="center" class="style3"><strong>Request Date</strong></div></td>
    <td bgcolor="#FF0000" ><div align="center" class="style3"><strong>ResponseDate</strong></div></td>
    <td bgcolor="#FF0000" ><div align="center" class="style3"><strong>Status</strong></div></td>
  </tr>
        <%
  ...
  <tr>
    <td height="29"><div align="center" class="style2"><%=s2%></div></td>
